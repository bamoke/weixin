...
App({
  onLaunch: function () {
    ...
    wx.login({
      success: res => {
        wx.request({
          url: 'https://www.bamoke.com/zhuyingtai/api.php/Account/mplogin',
          method: 'get',
          dataType: 'json',
          data: {
            code: res.code
          ...
          success: function (result) {
            if (result.data.code == 200) {
              ...
              wx.showToast({
                title: res.data.msg,
                image: "/static/image/icon-error-fill-white.png"
              })
            }
          }
        })
  ...
  ajax: function ({
    ...
    var myPromise = new Promise(function (resolve, reject) {
      const baseApiUrl = "https://www.bamoke.com/zhuyingtai/api.php";
      wx.request({
